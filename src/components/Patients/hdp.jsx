            ...
            <Box className="form-container" style={{
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{
                        ...
                        <label htmlFor="cp" style={{textAlign: 'center'}} >Chest Pain Type</label>
                        <select id="cp" name="cp" value={formData.cp} onChange={handleChange} style={{width: '50%', padding: '10px', marginLeft: '30%'}}>
                            <option value="">----select option----</option>
